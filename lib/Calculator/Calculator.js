...
function add(numbers) {
    if (typeof numbers !== 'string') {
        const err = new TypeError(`Argument 'numbers' must be of type string, ${typeof numbers} given`);
        throw err;
    }
    if (numbers === '') {
        return 0;
...
function getNumbersFromString(string) {
    if (typeof string !== 'string') {
        const err = new TypeError(`Argument 'string' must be of type string, ${typeof string} given`);
        throw err;
    }
...
function getIntegers(array) {
    if (Array.isArray(array) === false) {
        const err = new TypeError(`Argument 'array' must be of type array, ${typeof array} given`);
        throw err;
    }
    const integers = [];
...
function getSumOfNumbers(numbers) {
    if (Array.isArray(numbers) === false) {
        const err = new TypeError(`Argument 'numbers' must be of type array, ${typeof numbers} given`);
        throw err;
    }
    let result = 0;
...
function logJson(description, arg) {
    if (typeof description !== 'string') {
        const err = new TypeError(`Argument 'description' must be of type string, ${typeof description} given`);
        throw err;
    }
